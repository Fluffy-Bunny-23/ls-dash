...
function getApp(): FirebaseApp {
  ...
  app =
    ...
    initializeApp({
      ...
      authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN ?? "demo-ls-dash.firebaseapp.com",
      projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID ?? "demo-ls-dash",
    });
  return app;
}
